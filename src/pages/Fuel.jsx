...
import { Plus, Fuel as FuelIcon, Calendar, DollarSign, Gauge } from 'lucide-react'
        ...
        {fuelLogs.length > 0 && (
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-gradient-to-br from-green-600/20 to-green-500/10 border border-slate-700/50 rounded-lg p-4">
              <FuelIcon className="w-4 h-4 text-green-400 mb-2" />
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2 flex-wrap">
                        ...
                        {log.total_cost && (
                          <span className="bg-green-500/10 text-green-400 border border-green-500/30 px-2 py-1 rounded text-xs flex items-center gap-1">
                            <DollarSign className="w-3 h-3" />
                            {log.total_cost.toFixed(2)}
                          </span>
                        )}
                        {log.full_tank && (
                          <span className="bg-purple-500/10 text-purple-400 border border-purple-500/30 px-2 py-1 rounded text-xs">
                            Full Tank
                          </span>
                        )}
                      </div>
